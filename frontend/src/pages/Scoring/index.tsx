...
const Scoring = () => {
  ...
  const grandTotal = criteriaData.reduce(
                  ...
                  style={{
                    ...
                    background:
                      selectedTeamId === team.id
                        ...
                        : "transparent",
                    color:
                      selectedTeamId === team.id ? team.color : "var(--dim)",
                    cursor: "pointer",
                    fontSize: 13,
                    fontWeight: 700,
                  }}
                    ...
                    return (
                      <tr
                        ...
                        onMouseEnter={(e) => {
                          ...
                          ).style.background = cat.accentGlow.replace(
                            /[\d.]+\)$/,
                            "0.04)",
                          );
                        }}
                      ...
                      >
                        ...
                        <td
                          style={{ ...tdBase, fontSize: 12, color: "#5EAF7C" }}
                        >
                          <span style={{ opacity: 0.85 }}>＋</span> {sub.plus}
                        </td>
                        <td
                          style={{ ...tdBase, fontSize: 12, color: "#D04047" }}
                        >
                          ...
                          {(() => {
                            ...
                            return (
                              <input
                                ...
                                onBlur={(e) => {
                                  e.target.style.borderColor = hasSub
                                    ? `${cat.accent}66`
                                    : "rgba(255,255,255,.12)";
                                  e.target.style.boxShadow = hasSub
                                    ? `0 0 12px ${cat.accent}1A`
                                    : "none";
                                }}
                              />
