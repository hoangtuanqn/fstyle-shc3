...
_Một sản phẩm hợp tác giữa **[F-Code Club](https://www.facebook.com/faboratory)** và **[MST Software](https://github.com/mst-software)**_
...
```bash
# 1. Clone repo
git clone https://github.com/hoangtuanqn/fcode-web-system-challenge-3.git
cd fcode-web-system-challenge-3
...
Phát triển bởi **F-Code Club** × **MST Software** - phục vụ cộng đồng sinh viên FPT University HCM.
...
**F-Code Club** × **MST Software** · FPT University HCM · 2026
